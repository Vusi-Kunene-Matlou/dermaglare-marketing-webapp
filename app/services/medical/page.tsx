      ...
      sections={[
        {
          ...
          content: "Dr. Nkehli's expertise in medical dermatology encompasses a wide range of conditions. This includes but is not limited to, acne, pigmentation disorders, eczema, inflammatory skin diseases, autoimmune skin disorders, and skin cancers. Through a comprehensive examination and diagnosis, she determines the most suitable treatment for every patient."
        },
        {
          title: "Our Approach to Treatment",
          content: "At Dermaglare Skin, we believe in a patient-centered approach. Dr. Nkehli takes the time to listen to your concerns, evaluate your condition, and tailor a treatment plan that fits your specific needs. We utilise the latest advances in dermatology, ensuring that our patients receive the most current and effective treatments."
        },
        {
          title: "Prevention and Education",
          content: "Beyond treating existing conditions, Dermaglare Skin also places a strong emphasis on preventive care and patient education. We guide patients in understanding their skin better, teaching them how to protect it, and helping them make informed decisions about their skin health."
        }
      ]}
      features={[
