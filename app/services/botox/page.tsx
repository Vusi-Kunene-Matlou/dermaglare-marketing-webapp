      ...
      sections={[
        {
          ...
          content: "Hyperhidrosis, a condition characterised by excessive sweating, can be a major cause of discomfort and social anxiety for many. By blocking the nerves that stimulate your sweat glands, Botox injections can effectively reduce sweating in problem areas, including the underarms, palms, and feet."
        },
        {
          title: "Botox for Facial Wrinkles",
          content: "Botox has long been a go-to solution for smoothing out facial wrinkles. By temporarily relaxing the underlying muscles, Botox injections help soften fine lines and prevent deeper wrinkles from forming, providing a more youthful appearance. It's particularly effective on dynamic wrinkles, which are caused by muscle movement, such as crow's feet and frown lines."
        },
        {
          title: "The Botox Procedure with Dr. Jabu Nkehli",
          content: "Administered by the seasoned Dr. Jabu Nkehli, the Botox treatment process is swift and often painless, with results noticeable within a few days to a week post-procedure. Regular follow-up treatments are recommended to maintain the best results."
        }
      ]}
    />
  );
